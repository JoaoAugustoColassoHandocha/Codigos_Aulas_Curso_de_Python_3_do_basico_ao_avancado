...
def menu(op = 0):
    ...
    if op == '1':
        ...
        with open('Codigo_152\\Codigo_152_lista_tarefas.json', 'wa+', encoding = 'utf-8') as tarefas_add:
        ...
        with open('Codigo_152\\Codigo_152_lista_tarefas.json', 'r+', encoding = 'utf-8') as tarefas_lista:
