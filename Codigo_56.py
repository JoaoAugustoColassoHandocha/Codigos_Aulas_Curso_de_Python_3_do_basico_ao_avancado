...
print('\n' + '+' * 10 + '\n')
print(f'Sem Formatação: {numero_3}')
print('\n' + '+' * 10 + '\n')

# Primeira forma de contornar, imprimindo 0.80
print(f'Utilizando o Format: {numero_3:.2f}')
print('\n' + '+' * 10 + '\n')

# Segunda forma de contornar, imprimindo 0.8
print(f'Utilizando o Round: {round(numero_3, 1)}')
print('\n' + '+' * 10 + '\n')
...
print(f'Utilizando a biblioteca decimal: {numero_3}')
print('\n' + '+' * 10 + '\n')
